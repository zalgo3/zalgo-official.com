...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.GetVariationsResponse = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.ErrorData,
            root.ProductAdvertisingAPIv1.VariationsResult
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('VariationsResult')) {
                obj['VariationsResult'] = VariationsResult.constructFromObject(
