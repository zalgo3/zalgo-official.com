...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(
            require('../ApiClient'),
            require('./OfferConditionNote'),
            require('./OfferSubCondition')
        );
    } else {
        ...
        root.ProductAdvertisingAPIv1.OfferCondition = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.OfferConditionNote,
            root.ProductAdvertisingAPIv1.OfferSubCondition
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Locale')) {
                obj['Locale'] = ApiClient.convertToType(
                    data['Locale'],
                    'String'
                );
            }
            ...
            if (data.hasOwnProperty('SubCondition')) {
                obj['SubCondition'] = OfferSubCondition.constructFromObject(
                    data['SubCondition']
                );
            }
            if (data.hasOwnProperty('ConditionNote')) {
                obj['ConditionNote'] = OfferConditionNote.constructFromObject(
                    data['ConditionNote']
                );
            }
        }
