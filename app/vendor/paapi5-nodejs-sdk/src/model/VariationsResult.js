...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.VariationsResult = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.Item,
            root.ProductAdvertisingAPIv1.VariationSummary
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('VariationSummary')) {
                obj['VariationSummary'] = VariationSummary.constructFromObject(
                    data['VariationSummary']
                );
            }
        }
        return obj;
