...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.OfferDeliveryInfo = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.OfferShippingCharge
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('IsAmazonFulfilled')) {
                obj['IsAmazonFulfilled'] = ApiClient.convertToType(
                    data['IsAmazonFulfilled'],
                    'Boolean'
                );
            }
            if (data.hasOwnProperty('IsFreeShippingEligible')) {
                obj['IsFreeShippingEligible'] = ApiClient.convertToType(
                    data['IsFreeShippingEligible'],
                    'Boolean'
                );
            }
            if (data.hasOwnProperty('IsPrimeEligible')) {
                obj['IsPrimeEligible'] = ApiClient.convertToType(
                    data['IsPrimeEligible'],
                    'Boolean'
                );
            }
            if (data.hasOwnProperty('ShippingCharges')) {
                obj['ShippingCharges'] = ApiClient.convertToType(
