...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(
            require('../ApiClient'),
            require('./DimensionBasedAttribute'),
            require('./SingleBooleanValuedAttribute'),
            require('./SingleIntegerValuedAttribute'),
        ...
        root.ProductAdvertisingAPIv1.ProductInfo = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.DimensionBasedAttribute,
            root.ProductAdvertisingAPIv1.SingleBooleanValuedAttribute,
            root.ProductAdvertisingAPIv1.SingleIntegerValuedAttribute,
        ...
        exports.constructFromObject = function (data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('ItemDimensions')) {
                    obj['ItemDimensions'] =
                        DimensionBasedAttribute.constructFromObject(
                            data['ItemDimensions']
                        );
                }
                ...
                if (data.hasOwnProperty('UnitCount')) {
                    obj['UnitCount'] =
                        SingleIntegerValuedAttribute.constructFromObject(
                            data['UnitCount']
                        );
                }
            }
