...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.OfferPrice = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.OfferSavings,
            root.ProductAdvertisingAPIv1.PriceType
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Amount')) {
                obj['Amount'] = ApiClient.convertToType(
                    data['Amount'],
                    'Number'
                );
            }
            if (data.hasOwnProperty('Currency')) {
                obj['Currency'] = ApiClient.convertToType(
                    data['Currency'],
                    'String'
                );
            }
            if (data.hasOwnProperty('DisplayAmount')) {
                obj['DisplayAmount'] = ApiClient.convertToType(
                    data['DisplayAmount'],
                    'String'
                );
            }
            if (data.hasOwnProperty('PricePerUnit')) {
                obj['PricePerUnit'] = ApiClient.convertToType(
                    data['PricePerUnit'],
                    'Number'
                );
            }
            if (data.hasOwnProperty('PriceType')) {
                obj['PriceType'] = PriceType.constructFromObject(
                    data['PriceType']
                );
            }
            if (data.hasOwnProperty('PriceTypeLabel')) {
                obj['PriceTypeLabel'] = ApiClient.convertToType(
                    data['PriceTypeLabel'],
                    'String'
                );
            }
            if (data.hasOwnProperty('Savings')) {
                obj['Savings'] = OfferSavings.constructFromObject(
                    data['Savings']
                );
            }
        }
