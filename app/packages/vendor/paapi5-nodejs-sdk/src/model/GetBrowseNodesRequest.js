...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(
            require('../ApiClient'),
            require('./GetBrowseNodesResource'),
            require('./PartnerType')
        );
    } else {
        ...
        root.ProductAdvertisingAPIv1.GetBrowseNodesRequest = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.GetBrowseNodesResource,
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('BrowseNodeIds')) {
                obj['BrowseNodeIds'] = ApiClient.convertToType(
                    data['BrowseNodeIds'],
                    ['String']
                );
            }
