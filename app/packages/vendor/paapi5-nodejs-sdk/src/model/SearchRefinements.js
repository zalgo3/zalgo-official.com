...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.SearchRefinements = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.Refinement
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('BrowseNode')) {
                obj['BrowseNode'] = Refinement.constructFromObject(
                    data['BrowseNode']
                );
            }
            if (data.hasOwnProperty('OtherRefinements')) {
                obj['OtherRefinements'] = ApiClient.convertToType(
                    data['OtherRefinements'],
                    [Refinement]
                );
            }
            if (data.hasOwnProperty('SearchIndex')) {
                obj['SearchIndex'] = Refinement.constructFromObject(
                    data['SearchIndex']
                );
            }
        }
