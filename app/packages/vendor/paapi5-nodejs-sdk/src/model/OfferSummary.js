...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.OfferSummary = factory(
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('HighestPrice')) {
                obj['HighestPrice'] = OfferPrice.constructFromObject(
                    data['HighestPrice']
                );
            }
            if (data.hasOwnProperty('LowestPrice')) {
                obj['LowestPrice'] = OfferPrice.constructFromObject(
                    data['LowestPrice']
                );
            }
            if (data.hasOwnProperty('OfferCount')) {
                obj['OfferCount'] = ApiClient.convertToType(
                    data['OfferCount'],
                    'Number'
                );
            }
