...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(
            require('../ApiClient'),
            require('./BrowseNodeInfo'),
            require('./CustomerReviews'),
            require('./Images'),
            require('./ItemInfo'),
            require('./Offers'),
            require('./RentalOffers'),
            require('./VariationAttribute')
        );
    } else {
        ...
        root.ProductAdvertisingAPIv1.Item = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.BrowseNodeInfo,
            root.ProductAdvertisingAPIv1.CustomerReviews,
            root.ProductAdvertisingAPIv1.Images,
            root.ProductAdvertisingAPIv1.ItemInfo,
            root.ProductAdvertisingAPIv1.Offers,
            root.ProductAdvertisingAPIv1.RentalOffers,
            root.ProductAdvertisingAPIv1.VariationAttribute
        );
    }
})(
    this,
        ...
        exports.constructFromObject = function (data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('BrowseNodeInfo')) {
                    obj['BrowseNodeInfo'] = BrowseNodeInfo.constructFromObject(
                        data['BrowseNodeInfo']
                    );
                }
                if (data.hasOwnProperty('CustomerReviews')) {
                    obj['CustomerReviews'] =
                        CustomerReviews.constructFromObject(
                            data['CustomerReviews']
                        );
                }
                if (data.hasOwnProperty('DetailPageURL')) {
                    obj['DetailPageURL'] = ApiClient.convertToType(
                        data['DetailPageURL'],
                        'String'
                    );
                }
                ...
                if (data.hasOwnProperty('ItemInfo')) {
                    obj['ItemInfo'] = ItemInfo.constructFromObject(
                        data['ItemInfo']
                    );
                }
                ...
                if (data.hasOwnProperty('ParentASIN')) {
                    obj['ParentASIN'] = ApiClient.convertToType(
                        data['ParentASIN'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('RentalOffers')) {
                    obj['RentalOffers'] = RentalOffers.constructFromObject(
                        data['RentalOffers']
                    );
                }
                if (data.hasOwnProperty('Score')) {
                    obj['Score'] = ApiClient.convertToType(
                        data['Score'],
                        'Number'
                    );
                }
                if (data.hasOwnProperty('VariationAttributes')) {
                    obj['VariationAttributes'] = ApiClient.convertToType(
