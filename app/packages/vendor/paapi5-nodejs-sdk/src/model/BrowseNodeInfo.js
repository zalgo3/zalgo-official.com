...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.BrowseNodeInfo = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.BrowseNode,
            root.ProductAdvertisingAPIv1.WebsiteSalesRank
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('BrowseNodes')) {
                obj['BrowseNodes'] = ApiClient.convertToType(
                    data['BrowseNodes'],
                    [BrowseNode]
                );
            }
            if (data.hasOwnProperty('WebsiteSalesRank')) {
                obj['WebsiteSalesRank'] = WebsiteSalesRank.constructFromObject(
                    data['WebsiteSalesRank']
                );
            }
        }
        return obj;
