...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.ExternalIds = factory(
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EANs')) {
                obj['EANs'] = MultiValuedAttribute.constructFromObject(
                    data['EANs']
                );
            }
            if (data.hasOwnProperty('ISBNs')) {
                obj['ISBNs'] = MultiValuedAttribute.constructFromObject(
                    data['ISBNs']
                );
            }
            if (data.hasOwnProperty('UPCs')) {
                obj['UPCs'] = MultiValuedAttribute.constructFromObject(
                    data['UPCs']
                );
            }
        }
