...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(
            ...
            require('./Merchant'),
            require('./MinPrice'),
            require('./MinReviewsRating'),
            require('./MinSavingPercent'),
            require('./OfferCount'),
            require('./PartnerType'),
            require('./Properties'),
            require('./SearchItemsResource'),
            require('./SortBy')
        );
    } else {
        ...
        root.ProductAdvertisingAPIv1.SearchItemsRequest = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.Availability,
            root.ProductAdvertisingAPIv1.Condition,
            root.ProductAdvertisingAPIv1.DeliveryFlag,
            root.ProductAdvertisingAPIv1.MaxPrice,
            root.ProductAdvertisingAPIv1.Merchant,
            root.ProductAdvertisingAPIv1.MinPrice,
            root.ProductAdvertisingAPIv1.MinReviewsRating,
            root.ProductAdvertisingAPIv1.MinSavingPercent,
            root.ProductAdvertisingAPIv1.OfferCount,
            root.ProductAdvertisingAPIv1.PartnerType,
            root.ProductAdvertisingAPIv1.Properties,
            root.ProductAdvertisingAPIv1.SearchItemsResource,
            root.ProductAdvertisingAPIv1.SortBy
        );
    }
})(
    this,
        ...
        exports.constructFromObject = function (data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('Actor')) {
                    obj['Actor'] = ApiClient.convertToType(
                        data['Actor'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('Artist')) {
                    obj['Artist'] = ApiClient.convertToType(
                        data['Artist'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('Author')) {
                    obj['Author'] = ApiClient.convertToType(
                        data['Author'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('Availability')) {
                    obj['Availability'] = Availability.constructFromObject(
                        data['Availability']
                    );
                }
                if (data.hasOwnProperty('Brand')) {
                    obj['Brand'] = ApiClient.convertToType(
                        data['Brand'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('BrowseNodeId')) {
                    obj['BrowseNodeId'] = ApiClient.convertToType(
                        data['BrowseNodeId'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('Condition')) {
                    obj['Condition'] = Condition.constructFromObject(
                        data['Condition']
                    );
                }
                if (data.hasOwnProperty('CurrencyOfPreference')) {
                    obj['CurrencyOfPreference'] = ApiClient.convertToType(
                        data['CurrencyOfPreference'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('DeliveryFlags')) {
                    obj['DeliveryFlags'] = ApiClient.convertToType(
                        data['DeliveryFlags'],
                        [DeliveryFlag]
                    );
                }
                if (data.hasOwnProperty('ItemCount')) {
                    obj['ItemCount'] = ApiClient.convertToType(
                        data['ItemCount'],
                        'Number'
                    );
                }
                if (data.hasOwnProperty('ItemPage')) {
                    obj['ItemPage'] = ApiClient.convertToType(
                        data['ItemPage'],
                        'Number'
                    );
                }
                if (data.hasOwnProperty('Keywords')) {
                    obj['Keywords'] = ApiClient.convertToType(
                        data['Keywords'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('LanguagesOfPreference')) {
                    obj['LanguagesOfPreference'] = ApiClient.convertToType(
                        data['LanguagesOfPreference'],
                        ['String']
                    );
                }
                if (data.hasOwnProperty('Marketplace')) {
                    obj['Marketplace'] = ApiClient.convertToType(
                        data['Marketplace'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('MaxPrice')) {
                    obj['MaxPrice'] = MaxPrice.constructFromObject(
                        data['MaxPrice']
                    );
                }
                if (data.hasOwnProperty('Merchant')) {
                    obj['Merchant'] = Merchant.constructFromObject(
                        data['Merchant']
                    );
                }
                if (data.hasOwnProperty('MinPrice')) {
                    obj['MinPrice'] = MinPrice.constructFromObject(
                        data['MinPrice']
                    );
                }
                if (data.hasOwnProperty('MinReviewsRating')) {
                    obj['MinReviewsRating'] =
                        MinReviewsRating.constructFromObject(
                            data['MinReviewsRating']
                        );
                }
                if (data.hasOwnProperty('MinSavingPercent')) {
                    obj['MinSavingPercent'] =
                        MinSavingPercent.constructFromObject(
                            data['MinSavingPercent']
                        );
                }
                if (data.hasOwnProperty('OfferCount')) {
                    obj['OfferCount'] = OfferCount.constructFromObject(
                        data['OfferCount']
                    );
                }
                if (data.hasOwnProperty('PartnerTag')) {
                    obj['PartnerTag'] = ApiClient.convertToType(
                        data['PartnerTag'],
                        'String'
                    );
                }
                if (data.hasOwnProperty('PartnerType')) {
                    obj['PartnerType'] = PartnerType.constructFromObject(
                        data['PartnerType']
                    );
                }
                if (data.hasOwnProperty('Properties')) {
                    obj['Properties'] = Properties.constructFromObject(
                        data['Properties']
                    );
                }
                ...
                if (data.hasOwnProperty('SearchIndex')) {
                    obj['SearchIndex'] = ApiClient.convertToType(
                        data['SearchIndex'],
                        'String'
                    );
                }
                ...
                if (data.hasOwnProperty('Title')) {
                    obj['Title'] = ApiClient.convertToType(
                        data['Title'],
                        'String'
                    );
                }
