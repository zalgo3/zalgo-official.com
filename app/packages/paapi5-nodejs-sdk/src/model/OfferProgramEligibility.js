...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.OfferProgramEligibility = factory(
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('IsPrimeExclusive')) {
                obj['IsPrimeExclusive'] = ApiClient.convertToType(
                    data['IsPrimeExclusive'],
                    'Boolean'
                );
            }
            if (data.hasOwnProperty('IsPrimePantry')) {
                obj['IsPrimePantry'] = ApiClient.convertToType(
                    data['IsPrimePantry'],
                    'Boolean'
                );
            }
