...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(
            require('../ApiClient'),
            require('./BrowseNodeAncestor'),
            require('./BrowseNodeChild')
        );
    } else {
        ...
        root.ProductAdvertisingAPIv1.BrowseNode = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.BrowseNodeAncestor,
            root.ProductAdvertisingAPIv1.BrowseNodeChild
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Ancestor')) {
                obj['Ancestor'] = BrowseNodeAncestor.constructFromObject(
                    data['Ancestor']
                );
            }
            ...
            if (data.hasOwnProperty('ContextFreeName')) {
                obj['ContextFreeName'] = ApiClient.convertToType(
                    data['ContextFreeName'],
                    'String'
                );
            }
            ...
            if (data.hasOwnProperty('IsRoot')) {
                obj['IsRoot'] = ApiClient.convertToType(
                    data['IsRoot'],
                    'Boolean'
                );
            }
            if (data.hasOwnProperty('SalesRank')) {
                obj['SalesRank'] = ApiClient.convertToType(
                    data['SalesRank'],
                    'Number'
                );
            }
