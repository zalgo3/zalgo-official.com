...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.DimensionBasedAttribute = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.UnitBasedAttribute
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Height')) {
                obj['Height'] = UnitBasedAttribute.constructFromObject(
                    data['Height']
                );
            }
            if (data.hasOwnProperty('Length')) {
                obj['Length'] = UnitBasedAttribute.constructFromObject(
                    data['Length']
                );
            }
            if (data.hasOwnProperty('Weight')) {
                obj['Weight'] = UnitBasedAttribute.constructFromObject(
                    data['Weight']
                );
            }
            if (data.hasOwnProperty('Width')) {
                obj['Width'] = UnitBasedAttribute.constructFromObject(
                    data['Width']
                );
            }
        }
