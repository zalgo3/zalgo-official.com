...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(
            require('../ApiClient'),
            require('./OfferListing'),
            require('./OfferSummary')
        );
    } else {
        ...
        root.ProductAdvertisingAPIv1.Offers = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.OfferListing,
            root.ProductAdvertisingAPIv1.OfferSummary
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Listings')) {
                obj['Listings'] = ApiClient.convertToType(data['Listings'], [
                    OfferListing,
                ]);
            }
            if (data.hasOwnProperty('Summaries')) {
                obj['Summaries'] = ApiClient.convertToType(data['Summaries'], [
                    OfferSummary,
                ]);
            }
        }
