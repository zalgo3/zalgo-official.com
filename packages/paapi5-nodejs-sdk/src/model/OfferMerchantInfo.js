...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.OfferMerchantInfo = factory(
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DefaultShippingCountry')) {
                obj['DefaultShippingCountry'] = ApiClient.convertToType(
                    data['DefaultShippingCountry'],
                    'String'
                );
            }
            if (data.hasOwnProperty('FeedbackCount')) {
                obj['FeedbackCount'] = ApiClient.convertToType(
                    data['FeedbackCount'],
                    'Number'
                );
            }
            if (data.hasOwnProperty('FeedbackRating')) {
                obj['FeedbackRating'] = ApiClient.convertToType(
                    data['FeedbackRating'],
                    'Number'
                );
            }
