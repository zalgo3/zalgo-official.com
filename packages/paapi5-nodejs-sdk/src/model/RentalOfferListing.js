...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.RentalOfferListing = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.DurationPrice,
        ...
        exports.constructFromObject = function (data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('BasePrice')) {
                    obj['BasePrice'] = DurationPrice.constructFromObject(
                        data['BasePrice']
                    );
                }
