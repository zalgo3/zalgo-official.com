...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.GetItemsRequest = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.Condition,
            root.ProductAdvertisingAPIv1.GetItemsResource,
            root.ProductAdvertisingAPIv1.ItemIdType,
        ...
        exports.constructFromObject = function (data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('ItemIds')) {
                    obj['ItemIds'] = ApiClient.convertToType(data['ItemIds'], [
                        'String',
                    ]);
                }
                if (data.hasOwnProperty('ItemIdType')) {
                    obj['ItemIdType'] = ItemIdType.constructFromObject(
                        data['ItemIdType']
                    );
                }
