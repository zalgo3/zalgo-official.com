...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.TradeInInfo = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.TradeInPrice
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('IsEligibleForTradeIn')) {
                obj['IsEligibleForTradeIn'] = ApiClient.convertToType(
                    data['IsEligibleForTradeIn'],
                    'Boolean'
                );
            }
