...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.GetVariationsRequest = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.Condition,
            root.ProductAdvertisingAPIv1.GetVariationsResource,
        ...
        exports.constructFromObject = function (data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('ASIN')) {
                    obj['ASIN'] = ApiClient.convertToType(
                        data['ASIN'],
                        'String'
                    );
                }
                ...
                if (data.hasOwnProperty('VariationCount')) {
                    obj['VariationCount'] = ApiClient.convertToType(
                        data['VariationCount'],
                        'Number'
                    );
                }
                if (data.hasOwnProperty('VariationPage')) {
                    obj['VariationPage'] = ApiClient.convertToType(
                        data['VariationPage'],
                        'Number'
                    );
                }
