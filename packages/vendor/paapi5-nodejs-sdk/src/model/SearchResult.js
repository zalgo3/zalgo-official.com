...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.ProductAdvertisingAPIv1.SearchResult = factory(
            root.ProductAdvertisingAPIv1.ApiClient,
            root.ProductAdvertisingAPIv1.Item,
            root.ProductAdvertisingAPIv1.SearchRefinements
        );
    }
    ...
    exports.constructFromObject = function (data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('TotalResultCount')) {
                obj['TotalResultCount'] = ApiClient.convertToType(
                    data['TotalResultCount'],
                    'Number'
                );
            }
            if (data.hasOwnProperty('SearchURL')) {
                obj['SearchURL'] = ApiClient.convertToType(
                    data['SearchURL'],
                    'String'
                );
            }
            ...
            if (data.hasOwnProperty('SearchRefinements')) {
                obj['SearchRefinements'] =
                    SearchRefinements.constructFromObject(
                        data['SearchRefinements']
                    );
            }
        }
        return obj;
